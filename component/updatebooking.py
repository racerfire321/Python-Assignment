...
class updateBooking:
    ...
    def update_booking(self, event, index):
        ...
        self.confirmation_window = tk.Toplevel(self.main_frame)
        self.confirmation_window.title("Confirmation")

       # Add labels and entries for each piece of information
        tk.Label( self.confirmation_window, text="Pickup:").grid(row=0, column=0, padx=10, pady=5)
        ...
        tk.Label( self.confirmation_window, text="Destination:").grid(row=1, column=0, padx=10, pady=5)
        ...
        tk.Label( self.confirmation_window, text="Date:").grid(row=2, column=0, padx=10, pady=5)
        ...
        tk.Label( self.confirmation_window, text="Time:").grid(row=3, column=0, padx=10, pady=5)
        ...
        tk.Label( self.confirmation_window, text="Status:").grid(row=4, column=0, padx=10, pady=5)
        ...
        confirm_button = tk.Button( self.confirmation_window, text="Confirm Update")
    ...
    def confirm_update(self,event, index):
        ...
        # Update the entry widgets with the new data
