...
class ViewCustomer:
    def __init__(self, main_frame):
        ...
        self.tree = ttk.Treeview(self.body, columns=(
            "customer_id", "full_name", "dob", "phone_number", "gender", "user_type", "email", "password"),
                                 show="headings")
        ...
        db = AdminDatabase()
        data = db.customerTable() # Assuming you have a method named customerTable in your AdminDatabase class
